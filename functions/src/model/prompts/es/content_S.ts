export const CONTENT_PROMPT_S = `Descripción: Creando una actividad educativa para un movimiento juvenil
Detalles de la actividad: Tiempo: {0}, Tema: {1}, Público objetivo: grupo de {2} niños de edad {3}, Género: {4}, Ubicación: {5}, Notas adicionales: {6}
