export const CONTENT_PROMPT_S = `Description: Creando una actividad educativa para un movimiento juvenil
Détails de l'activité: Tiempo: {0}, Tema: {1}, Público objetivo: grupo de {2} niños de edad {3}, Género: {4}, Ubicación: {5}, Notas adicionales: {6}
