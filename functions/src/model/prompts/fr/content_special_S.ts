export const CONTENT_SPECIAL_PROMPT_S = `Description: Creando una actividad educativa para un movimiento juvenil
Détails de l'activité: Tiempo: {0} Tema: {1} Público objetivo: {2} niños con necesidades especiales, edades {3}, género de los niños: {4} Ubicación: {5} Notas adicionales: {6}
