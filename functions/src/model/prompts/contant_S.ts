export const CONTANT_PROMPT_S = `- אני מדריך בתנועת נוער. 
צור לי פעולה של {0},
נושא הפעולה הוא {1}.
...
++ פתיחה קצרה
++ 1 - 2 חלקים עם הוראות מפורטות והסברים שמשרתים את מטרות הפעולה, 
השתדל לייצר פעילויות שבה המדריך פחות מדבר ויש יותר משחקים, חידונים, תחרות או יצירה.
++ סיכום קצר
