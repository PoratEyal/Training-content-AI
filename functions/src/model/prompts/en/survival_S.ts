export const SURVIVAL_PROMPT_S = `Description: Creating an educational survival activity for a youth movement
...
- Appropriate for young kindergarten children
- Preference for building, experience, creation, physical work rather than explanations.
- Working in small groups and guidance for supervision
{9}
