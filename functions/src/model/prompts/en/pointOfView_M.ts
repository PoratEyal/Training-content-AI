export const VIEW_PROMPT_M = `Description: Creating an educational discussion activity for a youth movement
...
- Adapt the discussion questions to age and abilities
- Preference for questions and creating dialogue rather than the instructor talking
