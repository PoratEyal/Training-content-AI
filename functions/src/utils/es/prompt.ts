import { CONTENT_PROMPT_M } from "../../model/prompts/es/content_M";
import { CONTENT_PROMPT_S } from "../../model/prompts/es/content_S";
...
import { CONTENT_SPECIAL_PROMPT_M } from "../../model/prompts/es/content_special_M";
import { CONTENT_SPECIAL_PROMPT_S } from "../../model/prompts/es/content_special_S";
...
export const getSafty = (
    ...
    let safety: string = "- La actividad debe ser: sin violencia, sin peligro";
    if (contest === "sin grupos") safety += ", sin competencias y sin dividir grupos.";
    return safety;
};
