                    ...
                    <Routes>
                        <Route element={<PrivateRoutes />}>
                            <Route path="/" element={
                                <>
                                    <Helmet>
                                        <title>בונה פעולות - מילוי פרטים על הקבוצה</title>
                            ...
                            <Route path="/choosePath" element={
                                <>
                                    <Helmet>
                                        <title>בונה פעולות - בניית הפעולה המתאימה ביותר בשבילכם</title>
                                        <meta name="description" content="צור פעולות מרתקות ומותאמות אישית עבור חניכיך תוך דקות ספורות באמצעות כלי בינה מלאכותית חדשניים. חסוך זמן, התמקד ביצירתיות, והענק לחניכים חוויה חינוכית בלתי נשכחת" />
                                    </Helmet>
                                    <ChoosePath />
                                </>
                            ...
                            <Route path="/activity" element={
                                <>
                                    <Helmet>
                                        <title>בונה פעולות - קבלת פעולה מותאמת אישית בשילוב בינה מלאכותית להדרכת תנועות נוער</title>
                                        <meta name="description" content="צור פעולות מרתקות ומותאמות אישית עבור חניכיך תוך דקות ספורות באמצעות כלי בינה מלאכותית חדשניים. חסוך זמן, התמקד ביצירתיות, והענק לחניכים חוויה חינוכית בלתי נשכחת" />
                                    </Helmet>
                                    <Activity />
                                </>
