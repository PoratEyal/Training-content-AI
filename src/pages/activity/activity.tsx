    ...
    const generateAgain = async (index) => {
        if (index == 1) {
            try {
                ...
                const result = await getPointOfView(
                    data.pointOfView.subject,
                    data.pointOfView.time,
                    data.amount,
                    data.grade,
                    data.gender,
                    data.place,
        ...
        if (index == 2) {
            try {
                ...
                const result = await getContentActivity(
                    data.contentActivity.subject,
                    data.contentActivity.time,
                    data.amount,
                    data.grade,
                    data.gender,
                    data.place,
        ...
        if (index == 3) {
            try {
                ...
                const result = await getScoutingTime(
                    data.scoutingTime.subject,
                    data.scoutingTime.time,
                    data.amount,
                    data.grade,
                    data.gender,
                    data.place,
        ...
        if (index == 4) {
            try {
                ...
                const result = await getPlayingTime(
                    data.playingTime.subject,
                ...
                <div className={styles.activity_div}>
                    <div className={styles.h2_icon_div}>
                        ...
                        <div className={styles.icons}>
                            {!whatsupPoint ? (
                                <FaWhatsapp onClick={() => importWhatsup(1)}></FaWhatsapp>
                            ) : (
                                <AiOutlineLoading></AiOutlineLoading>
                            )}
                            {!docsPoint ? (
                                <BsFiletypeDocx onClick={() => importDocs(1)}></BsFiletypeDocx>
                            ) : (
                                <AiOutlineLoading></AiOutlineLoading>
                            )}
                        </div>
            ...
            {data.contentActivity.use && (
                <div className={styles.activity_div}>
                    <div className={styles.h2_icon_div}>
                        ...
                        <div className={styles.icons}>
                            {!whatsupContent ? (
                                <FaWhatsapp onClick={() => importWhatsup(2)}></FaWhatsapp>
                            ) : (
                                <AiOutlineLoading></AiOutlineLoading>
                            )}
                            {!docsContent ? (
                                <BsFiletypeDocx onClick={() => importDocs(2)}></BsFiletypeDocx>
                            ) : (
                                <AiOutlineLoading></AiOutlineLoading>
                            )}
                        </div>
            ...
            {data.scoutingTime.use && (
                <div className={styles.activity_div}>
                    <div className={styles.h2_icon_div}>
                        ...
                        <div className={styles.icons}>
                            {!whatsupScoutingTime ? (
                                <FaWhatsapp onClick={() => importWhatsup(3)}></FaWhatsapp>
                            ) : (
                                <AiOutlineLoading></AiOutlineLoading>
                            )}
                            {!docsScoutingTime ? (
                                <BsFiletypeDocx onClick={() => importDocs(3)}></BsFiletypeDocx>
                            ) : (
                                <AiOutlineLoading></AiOutlineLoading>
                            )}
                        </div>
            ...
            {data.playingTime.use && (
                <div className={styles.activity_div}>
                    <div className={styles.h2_icon_div}>
                        ...
                        <div className={styles.icons}>
                            {!whatsupPlaying ? (
                                <FaWhatsapp onClick={() => importWhatsup(4)}></FaWhatsapp>
                            ) : (
                                <AiOutlineLoading></AiOutlineLoading>
                            )}
                            {!docsPlaying ? (
                                <BsFiletypeDocx onClick={() => importDocs(4)}></BsFiletypeDocx>
                            ) : (
                                <AiOutlineLoading></AiOutlineLoading>
                            )}
                        </div>
