...
function Details() {
    ...
    useEffect(() => {
        // const checkTerms = () => {
        //     const isTerms = Cookies.get('terms');
        //     setTimeout(() => {
        //         console.log("!",isTerms)
        //         if (isTerms == "true") {
        //             console.log("truw")
        ...
        // const checkAccess = () => {
        //     const lastAccessDate = Cookies.get('lastAccessDate');
        //     const today = new Date().toDateString();

        //     if (lastAccessDate === today.toString()) {
        //         setDisabledBtn(true);
        //         setIsLimit(true);
        //     } else {
        //         setDisabledBtn(false);
        //         Cookies.set('lastAccessDate', today, { expires: 1 });
        //         setIsLimit(false);
        //     }
        // };
    ...
    return (
        <div className={styles.container}>
            {/* {isTerms ? <TermsAndConds handleClick={setIsTerms(false)} /> : null} */}
            {/* {isLimit ? <LimitRequest /> : null} */}
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className={styles.btn_div}>
                    <button disabled={disabledBtn} onClick={() => setClicked(true)} className={styles.submit_btn} type="submit">
                        {!clicked ?
                            "המשיכו"
                        :
