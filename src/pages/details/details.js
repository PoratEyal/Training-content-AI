        ...
        <div className={styles.container}>
            <form onSubmit={handleSubmit}>
                ...
                <div className={styles.input_div}>
                    ...
                    >
                        <option value="" disabled>בחר מספר ילדים</option>
                ...
                <div className={styles.input_div}>
                    ...
                    >
                        <option value="" disabled>בחר מיקום הפעילות</option>
                ...
                <div className={styles.input_div}>
                    ...
                    >
                        <option value="" disabled>בחר אורך הפעילות</option>
