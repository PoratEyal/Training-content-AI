...
export const fetchGetActivity = async (request: GetActivityRequest,): Promise<GetActivityResponse> => {
...
export const fetchCreateNewUser = async (request: CreateNewUserRequest,): Promise<CreateNewUserResponse> => {
...
export const fetchGetSavedActivities = async (userId: string,): Promise<getSavedActivitiesResponse> => {
...
export const fetchRemoveActivity = async (request: RemoveActivityRequest,): Promise<removeActivityResponse> => {
...
export const fetchGetStaticActivity = async (request: GetStaticActivityRequest,): Promise<GetStaticActivityResponse> => {
    try {
...
export const fetchIncrementActivityDisplayCount = async (activity: StaticActivities,): Promise<incrementActivityDisplayCountResponse> => {
    try {
...
export const fetchAddStaticActivity = async (activityText: string, activityId: string,): Promise<AddStaticActivityResponse> => {
    try {
